...
const Sidebar = () => {
  const sidedata = [
    { id: "a11", name: "Dashboard", image: assets.home_icon, path: "/" },
    { id: "aa112", name: "Appointment", image: assets.appointment_icon, path: "/appoinment" },
    { id: "aaa1211", name: "Add Doctor", image: assets.add_icon, path: "/addDoctor" },
    { id: "aase934993", name: "Doctor List", image: assets.people_icon, path: "/doctorlist" },
  ];
