...
const SignIn = () => {
  ...
  const {
    setSignIn,signIn,signInOnChangeHandler,signInSubmitHandler} = useContext(AContextt)
  ...
  return (
    ...
    >
      ...
      <div className='w-full h-fit flex gap-2'>
        <h4 className='font-bold text-md text-black'>Doctor Login here</h4>
        <NavLink to={"/dsignin"}><p className='text-blue-500 tracking-tighter'>Click here</p></NavLink>
      </div>
